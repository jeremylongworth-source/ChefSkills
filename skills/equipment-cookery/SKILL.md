...
## Core Workflow
1. Identify the food, target result, equipment available, missing equipment, vessel size/material, heat source, batch size, fill level, airflow, lid/pressure/steam state, and safety-sensitive ingredients.
2. Run a safety preflight for raw animal products, reheating, holding, pressure canning, slow cookers, microwaves, damaged equipment, and missing time-temperature facts.
...
4. Map the equipment constraint to the mechanism: heat capacity, surface area, conductivity, airflow, moisture evaporation, steam capture, pressure, agitation, cold spots, recovery time, or batch sequencing.
5. Recommend practical adjustments: smaller batches, alternate vessels, rack position, preheating, lid changes, stirring, rotation, standing time, thermometer checks, or a different method.
...
For pressure cooking and canning, distinguish pressure cookers, electric multi-cookers, and pressure canners. Do not convert canning processes between equipment types or imply low-acid canning is safe without tested pressure-canner guidance.

Route to `food-safety` when equipment advice touches raw animal products, reheating leftovers, holding temperatures, pressure canning, slow cookers, microwaves with potentially underheated food, damaged equipment, or uncertain time-temperature history.

## Output Contract
- Food, target result, and equipment constraint
- Safety gate and missing equipment/time-temperature facts
- Equipment state: vessel size/material, heat source, fill level, airflow, lid/steam/pressure, and batch size
