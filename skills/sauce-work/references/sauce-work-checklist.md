# Sauce Work Checklist

- Sauce family is identified before mechanism or recovery advice.
- Current state and target state are explicit for troubleshooting.
- Emulsion, reduction, starch, dairy, fat, acid, and seasoning mechanisms are separated.
- Interventions are staged and reversible where possible.
- Heat control and order of operations are specified.
