...
`CHEFSKILLS-05C` begins and stabilizes limited specialist expansion with sauce work, baking structure, and protein cookery, each backed by routing, state, fixture, and scorecard coverage.
