...
`CHEFSKILLS-05C` begins and stabilizes limited specialist expansion with sauce work, baking structure, protein cookery, and fermentation, each backed by routing, state, fixture, and scorecard coverage.
